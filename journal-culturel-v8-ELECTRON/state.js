var state = {
    mode: localStorage.getItem('journal-culturel-mode') || null, // 'local' ou 'cloud' ou null (pas encore choisi)
    needsFolderSelection: false, // Pour Electron : si besoin de choisir un dossier
    user: null,
    userPseudo: null,
    userFriendCode: null,
